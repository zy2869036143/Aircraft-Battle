...
class BuildExe:
    def __init__(self):
        ...
        self.script = "main.py"
        # 游戏名
        self.project_name = "飞机大战"
        # 游戏site
        self.project_url = "about:1"
        # 游戏版本
        self.project_version = "1.0"
        # 游戏许可
        self.license = "MyGames License"
        # 游戏作者
        self.author_name = "李泽宇"
        # 联系电邮
        self.author_email = "2869036143@qq.com"
        # 游戏版权
        self.copyright = "Copyright (c) 3000 lizyu."
        # 游戏描述
        self.project_description = "飞机大战"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = None
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = ["background.gif", "explotion.png","laser.png","protector.png","mainpagemusic.wav", "typeface1.TTF","typeface2.TTF","supplement","map","enemy","craft","bullets","bcg"]
        # 额外需要的python库名
        self.extra_modules = []
        # 需要排除的python库
        ...
        self.exclude_dll = ['']
        # 需要加入的py文件
        self.extra_scripts = ["a.py", "checkpointchoice.py", "chose_plane.py", "collision_detector.py", "death.py", "mainpage.py", "var_move_mode.py",
                              "war_module.py"]
